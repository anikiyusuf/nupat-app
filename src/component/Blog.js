  ...
  return (
    <div className="BlogSection">
       <div className="BlogTitle">
         <div className="blogHeader"> <div style={{background: "linear-gradient(94.06deg, #FFB629 -1.21%, #FFDA56 58.66%, #FFD7A6 116.84%)", width: "4px",height: "30px"}}></div><p>Our Blog</p></div>
         <h2>Our Latest News</h2>
       </div>
       <hr   className="underline"/>
<div className="Calender">
<div className="Eight">
<img src="Range.png" alt="avatar" />
<div className="calenderEight">
...
<div style={{border: "1px solid #D8D8D8", height:"300px"}}></div>
...
<img src="Canton.png" alt=""/>
<p className="read">Read More</p>
<div className="calenderTwelve">
<svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="11" y="28" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
<rect x="11" y="41" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
<rect x="24" y="28" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
...
<div className="twentyFive">
   <img src="Cosco.png" alt="avatar" />
<div className="calenderTwentyFive">
<svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="11" y="28" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
<rect x="11" y="41" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
<rect x="24" y="28" width="6" height="6" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
...
<li>Reliable & experienced staffs</li>
      ...
      <button className="BlogBtn">More Blog <svg width="36" height="25" viewBox="0 0 36 25" fill="none" xmlns="http://www.w3.org/2000/svg">
